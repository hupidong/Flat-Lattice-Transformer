...
raw_dataset_cache_name = os.path.join('cache', args.dataset +
                                      ...
                                      + 'only_train_min_freq_{}&'.format(args.only_train_min_freq)
                                      + 'number_norm_{}&'.format(args.number_normalized)
                                      + 'load_dataset_seed_{}'.format(load_dataset_seed)
                                      )
...
elif args.dataset == 'pd2014':
    datasets, vocabs, embeddings = load_pd2014_ner(pd2014_ner_path, yangjie_rich_pretrain_unigram_path,
                                                   yangjie_rich_pretrain_bigram_path,
                                                   _refresh=refresh_data, index_token=False,
                                                   _cache_fp=raw_dataset_cache_name,
                                                   char_min_freq=args.char_min_freq,
