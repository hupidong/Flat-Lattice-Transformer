...
def load_resume_ner(path, char_embedding_path=None, bigram_embedding_path=None, index_token=True,
    ...
    train_path = os.path.join(path, 'train.resume.char.bmes')
    dev_path = os.path.join(path, 'dev.resume.char.bmes')
    test_path = os.path.join(path, 'test.resume.char.bmes')
...
@cache_results(_cache_fp='cache/pd2014_ner', _refresh=False)
def load_pd2014_ner(path, char_embedding_path=None, bigram_embedding_path=None, index_token=True,
                    char_min_freq=1, bigram_min_freq=1, only_train_min_freq=0):
    from fastNLP.io.loader import ConllLoader
    from utils import get_bigrams

    train_path = os.path.join(path, 'train.pd2014.char.bio')
    dev_path = os.path.join(path, 'dev.pd2014.char.bio')
    test_path = os.path.join(path, 'test.pd2014.char.bio')
